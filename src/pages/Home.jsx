        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="card bg-white rounded-lg shadow-md overflow-hidden">
            <div className="md:flex">
              ...
              <div className="p-6 md:w-2/3">
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Fresh Salad</h3>
                <p className="text-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="testimonial bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="flex items-center">
                <img src="../media/imgs/person1.jpg" alt="Person 1" className="w-12 h-12 rounded-full mr-4" />
                <div>
            ...
            <div className="testimonial bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="flex items-center">
                <img src="../media/imgs/person2.jpg" alt="Person 2" className="w-12 h-12 rounded-full mr-4" />
                <div>
            ...
            <div className="testimonial bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="flex items-center">
                <img src="../media/imgs/person3.jpg" alt="Person 3" className="w-12 h-12 rounded-full mr-4" />
                <div>
